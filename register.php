...
<div id="container-user-akses">
	<form action="<?php echo BASE_URL.'function/proses_registrasi.php'?>" method="POST">
		<?php
			...
			if($notif == "require"){
				echo "<div class='notif'>Lengkapi Form dengan benar !!</div>";
			}else if($notif == "password"){
				echo "<div class='notif'>Password yang anda masukan tidak sama !!</div>";
			}else if($notif == "email"){
				echo "<div class='notif'>Email anda sudah terdaftar !!</div>";
			}
		?>
